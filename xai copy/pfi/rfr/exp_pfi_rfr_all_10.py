...
model = RandomForestRegressor(random_state=42, max_depth=20, max_features=None, n_estimators=300)
...
pd.concat([df_pfi.iloc[::-1]['var_name'],df_pfi.iloc[::-1]['importance']], axis=1).to_csv('csv/exp_sorted_best_selected_rfr_all.csv')
...
# plt.grid()
plt.tight_layout()
plt.savefig("img/exp_pfi_rfr_all_10.png")
