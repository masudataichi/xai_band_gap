...
# 結果をデータフレームに変換して表示
results_sorted_df = pd.read_csv("csv/mp_sorted_gbr_ft_elimination.csv")
results_random_df = pd.read_csv("csv/mp_random_gbr_ft_elimination.csv")
...
plt.ylim(0.375, 0.655)
plt.tight_layout()
plt.savefig("img/vis_mp_gbr_ft_elimination.png")
# 結果をCSVファイルに保存
