...
# 結果をデータフレームに変換して表示
results_sorted_df = pd.read_csv("csv/exp_sorted_gbr_ft_elimination.csv")
results_random_df = pd.read_csv("csv/exp_random_gbr_ft_elimination.csv")
...
plt.tight_layout()
plt.savefig("img/vis_exp_gbr_ft_elimination.png")
# 結果をCSVファイルに保存
