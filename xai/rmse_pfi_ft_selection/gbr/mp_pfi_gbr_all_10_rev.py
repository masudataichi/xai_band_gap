...
pd.concat([df_pfi.iloc[::-1]['var_name'],df_pfi.iloc[::-1]['importance']], axis=1).to_csv('csv/mp_sorted_best_selected_gbr_all_rev.csv')
...
# plt.grid()
plt.xlim(0, 1.0)
plt.title("GBR (MP dataset)", fontsize=25)

plt.savefig("img/mp_pfi_gbr_all_10_rev.png")
