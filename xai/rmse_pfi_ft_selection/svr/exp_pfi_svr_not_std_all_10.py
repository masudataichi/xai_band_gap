...
pd.concat([df_pfi.iloc[::-1]['var_name'],df_pfi.iloc[::-1]['importance']], axis=1).to_csv('csv/exp_sorted_best_selected_svr_not_std_all.csv')
...
# plt.grid()
plt.tight_layout()
plt.savefig("img/exp_pfi_svr_not_std_all_10.png")
