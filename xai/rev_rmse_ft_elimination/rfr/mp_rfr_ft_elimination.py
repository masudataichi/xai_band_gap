...
sorted_features_path = '../../rmse_pfi/rfr/csv/mp_sorted_best_selected_rfr_all_rev.csv'
...
plt.tight_layout()
plt.savefig("img/mp_rfr_ft_elimination.png")

# 結果をCSVファイルに保存
results_sorted_df.to_csv('csv/mp_sorted_rfr_ft_elimination.csv', index=False)
results_random_df.to_csv('csv/mp_random_rfr_ft_elimination.csv', index=False)
