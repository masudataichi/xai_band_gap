...
# Best parameters found:  {'learning_rate': 0.07, 'max_depth': 5, 'n_estimators': 5000}
# Best scores found:  -0.3962541170203202
...
output_results.to_csv('response_letter_grid_search/gbr_mp.csv', index=False)