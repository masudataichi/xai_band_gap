...
def find_top_correlated_features(df, dataset_name):
    ...
    plt.xlabel('Absolute correlation coefficient with band gap',fontsize=20)
    ...
    plt.tight_layout()
    plt.savefig(f'img/{dataset_name}_top_10_features_correlated_with_target.png')
    ...
    output_csv_path = f'csv/{dataset_name}_top_10_features_correlated_with_target.csv'
