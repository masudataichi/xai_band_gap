...
selected_feature = pd.read_csv("../../rmse_pfi/gbr/csv/mp_sorted_best_selected_gbr_all_rev.csv").iloc[:,1].tolist()

df_mp = pd.read_csv("../../dataset/df_mp_merged.csv")
x_train = df_mp.iloc[:, 1:-1]
y_train = df_mp.iloc[:,-1]
x_train = x_train[selected_feature]
# x_train.to_csv("../../dataset/fi_sorted/gbr/mp/df_mp_merged_fi_sorted.csv")
...
class PartialDependence:
    ...
    def plot(self, i, ylim: list[float] | None = None) -> None:
        ...
        fig.savefig("img/mp_rev/mp_pdp_gbr_rev" + str(i))
