...
selected_feature = pd.read_csv("../../pfi/svr/csv/exp_sorted_best_selected_svr_not_std_all.csv").iloc[:,1].tolist()
...
X_train_std = pd.DataFrame(normalizer.transform(x_train))
...
class PartialDependence:
    ...
    def plot(self, i, ylim: list[float] | None = None) -> None:
        ...
        fig.savefig("img/exp/not_std/exp_pdp_svr" + str(i))
...
# pdp.partial_dependence(selected_feature[41], n_grid=50)
# pdp.plot(41, ylim=(1.1,3.0))
# pdp.partial_dependence(selected_feature[69], n_grid=50)
# pdp.plot(69, ylim=(1.1,3.0))