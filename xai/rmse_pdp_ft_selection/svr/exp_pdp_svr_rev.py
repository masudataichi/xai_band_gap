...
selected_feature = pd.read_csv("../../rmse_pfi_ft_selection/svr/csv/exp_sorted_best_selected_svr_all_rev.csv").iloc[:,1].tolist()
...
class PartialDependence:
    ...
    def plot(self, i, ylim: list[float] | None = None) -> None:
        ...
        fig.savefig("img/exp_rev/exp_pdp_svr_rev" + str(i))
