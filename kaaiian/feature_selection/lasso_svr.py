...
y_predict.to_csv("y_predict_svr.csv")
print("MAE")
...
mae_list_datframe.to_csv("mae_list_svr.csv")
print(len(best_selected))
selected_list_datframe = pd.DataFrame(selected_list)
selected_list_datframe.to_csv("select_list_svr.csv")
best_selected_datframe = pd.DataFrame(best_selected)
best_selected_datframe.to_csv("best_selected_svr.csv")
print(best_selected)